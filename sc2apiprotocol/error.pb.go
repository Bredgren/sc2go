...
func (ActionResult) EnumDescriptor() ([]byte, []int) { return fileDescriptorError, []int{0} }

func init() {
	proto.RegisterEnum("ActionResult", ActionResult_name, ActionResult_value)
}

func init() { proto.RegisterFile("s2clientprotocol/error.proto", fileDescriptorError) }

var fileDescriptorError = []byte{
	// 2197 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x09, 0x6e, 0x88, 0x02, 0xff, 0x74, 0x58, 0xf7, 0x9b, 0x1b, 0xb7,
